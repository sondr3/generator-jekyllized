...
module.exports = yeoman.generators.Base.extend({
  constructor: function() {
    ...
    this.pkg = JSON.parse(this.readFileAsString(path.join
  ...
  projectPrompting: function() {
    ...
    this.log(yosay('Time to supercharge your Jekyll development!'));
    ...
    var prompts = [{
      ...
      name: 'projectURL',
      message: chalk.red('If you are using GH Pages use username.github.io') +
  ...
  uploadPrompting: function() {
    ...
    this.log(chalk.yellow('\nTime to choose how to upload your site: >>') +
            chalk.red('\nNOTE: Take whatever time you need to get these ' +
              'right/fill them in later in eithers credentials file.'));
    ...
    var prompts = [{
      ...
      name: 'amazonKey',
      message: chalk.yellow('\n\nNow we just need to fill out the detailes ' +
          'needed to configure your site for Amazon S3 and Cloudfront: >>') +
        chalk.red('\nNOTE: Take your time to correctly fill these out') +
        chalk.red('\nOr leave them blank and') +
      ...
      name: 'rsyncUsername',
      message: chalk.yellow('\n\nNow we just need to fill out the details ' +
          'needed to upload your site via Rsync: >>') +
        chalk.red('\nNOTE: Take your time to correctly fill these out') +
        chalk.red('\nOr leave them blank and') +
  ...
  scaffolding: function() {
    ...
    if (this.amazonCloudfrontS3) {
      ...
      this.template('conditionals/_rsync-credentials.json',
